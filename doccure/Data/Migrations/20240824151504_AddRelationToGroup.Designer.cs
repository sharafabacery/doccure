...
namespace doccure.Data.Migrations
{
    ...
    [Migration("20240824151504_AddRelationToGroup")]
    partial class AddRelationToGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("doccure.Data.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("doccure.Data.Models.UserConnected", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("doccure.Data.Models.Applicationuser", b =>
                {
                    b.HasOne("doccure.Data.Models.Group", null)
                        .WithMany("user")
            ...
            modelBuilder.Entity("doccure.Data.Models.Comment", b =>
                {
                    ...
                    b.HasOne("doccure.Data.Models.Applicationuser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("doccure.Data.Models.Review", b =>
                {
                    b.HasOne("doccure.Data.Models.Booking", "booking")
                        .WithOne("Review")
                        .HasForeignKey("doccure.Data.Models.Review", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
